...
const mongoCluster = "mongodb+srv://jooshe:pgad5360@cluster0.gfdcniy.mongodb.net/";
...
app.get("/", function(req, res){
  // Get all the posts in our data base and display them on the home screen
...
app.post("/compose", function(req, res) {
  ...
  Post.findOne({title: post.title}, (err, foundPost) => {
    if (!err) {
      if (!foundPost) {
        post.save();
        console.log("Post successfuly saved")
      } else {
